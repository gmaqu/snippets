...
1. Import the zscaler .crt from step 3 above.
...
Workaround for zscaler cert issue, if the above step doesn't work: `-Dmaven.wagon.http.ssl.insecure=true -Dmaven.wagon.http.ssl.allowall=true`
